...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.html" class="brand-link">
      <img src="gambar/telkom.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">DAMABIS</a>
        </div>
      </div> -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/dataskembis.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>A2P Domestik</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/datarate.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>A2P Domestik</p>
                </a>
              </li>
