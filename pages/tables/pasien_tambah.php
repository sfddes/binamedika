  ...
  <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <small>Tambah Data Pasien Baru </small>
        </h1>
      </section>
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" >Data Pasien</h5>
          <button href="datapasien.php"type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span href="datapasien.php"aria-hidden="true" >&times;</span>
          </button>
        </div>       
        <div class="box-body">
          <div class="container">
            <form action="pasien_act.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Jenis Kelamin</label>
                  ...
                  <option disable selected>Selected Jenis Kelamin</option>
              ...
              <div class="modal-footer">
                  <button style="background-color:#00FFF; border-color:gray; color:white" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
