...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="pages/tables/riwayatobat.php" class="nav-link active" style="background-color:#69D4D4; border-color:gray; color:white">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <small>Tambah Data Riwayat Obat Baru</small>
      </h1>
    </section>
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          <?php 
          $id = $_GET['id'];
          $data = mysqli_query($koneksi,"select * from dataresep where id='$id'");
          while($d = mysqli_fetch_array($data)){
          ?>
            <form action="riwayat_update.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Nama Pasien</label>
                  <input type="hidden" name="id_riwayat" value="<?php echo $d['id_riwayat']; ?>">
                  <input type="text" class="form-control" name="nama_pasien" required="required" value="<?php echo $d['nama_pasien']?>">
                </div>
                <div class="form-group">
                  <label>Jenis Pasien</label>
                  <input type="text" class="form-control" name="jenis_pasien" value="<?php echo $d['jenis_pasien']?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="aturan_pakai"  value="<?php echo $d['aturan_pakai'] ?>">
                </div>
                <div class="form-group">
                  <label>Tgl Transaksi</label>
                  <input type="text" class="form-control" name="tgl_periksa" value="<?php echo $d['tgl_periksa'] ?>">
                </div>
                <div class="form-group">
                  <label>Total ADM</label>
                  <input type="text" class="form-control" name="tot_adm" value="<?php echo $d['tot_adm'] ?>">
                </div>
